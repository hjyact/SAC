...
class TwinCritic(nn.Module):
    ...
    def __init__(self, obs_dim: int, action_dim: int, hidden_dims: List[int], activation: str = "relu"):
        ...
        self.q1 = build_mlp(in_dim, 1, hidden_dims, activation=activation, use_layer_norm=True)
        self.q2 = build_mlp(in_dim, 1, hidden_dims, activation=activation, use_layer_norm=True)
